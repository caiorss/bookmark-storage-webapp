...
export function item_set_starred(checkbox) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (resp.is_status_success()) {
            ...
            yield toastNotification("Toggle starred settings. Ok.");
            dom.page_refresh();
        }
        else {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (query_params.get("filter") == "collection") {
            ...
            if (res.is_status_success()) {
                ...
                yield toastNotification("Bookmark added successfuly.");
                dom.page_refresh();
            }
        ...
        if (res.is_status_success()) {
            ...
            yield toastNotification("Error: " + body["error"]);
            document.location.href = `/items?filter=search&query=${url}`;
